...
2. Avg Delivery Time та Late delivery rate (по містах, брендах, зонах Одеси) з підсвічуванням критичних
3. SKU-доступність по тижнях (по брендах + пивот по магазинах)
4. Рекомендації

Дані: 20.04 – 22.06.2026. Кнопка «Завантажити PDF» експортує весь звіт із графіками.
